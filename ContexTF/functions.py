import os, sys, re, time, gzip, glob, json, zlib, operator, logging, io
...
def add_sequences_to_flanking_genes_from_local_assembly(flanking_genes, target_ncbi_code, protein_file):
    print(' ... ... Collecting sequences for flanking proteins from provided assembly')
...
def compute_all_against_all_distance_matrix(in_syntenies, out_label = None, num_threads = None, num_alignments = None, max_evalue = None, num_iterations = None, blast = None, mmseqs = None, default_base = None, tmp_folder = None, mode = 'flanking_sequences', method = 'blast', min_coverage=None):
    ...
    ### Routines for executing local MMseqs2 to find te families
...
def find_and_add_protein_families(in_syntenies, out_label = 'default', num_threads = 1, num_alignments = 50000, max_evalue = 1e-3, num_iterations = 1, blast = 'psiblast', mmseqs = 'mmseqs', min_coverage = 70, default_base = 10, tmp_folder = '/tmp', method = 'psiblast'):
    ordered_ncbi_codes = []
